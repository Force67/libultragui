...
int main() {
    ...
    while (!platform.ShouldClose()) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            ugui::Color btn_color = ugui::Lerp(ugui::Color::FromHex(0x0f3460),
        ...
        renderer.DrawRect({520, 100 + bounce, 700, 500}, ugui::Color::FromHex(0x533483, 0.85f),
                           24.0f);

        // Nested content
        renderer.DrawRect({560, 160 + bounce, 620, 120}, ugui::Color::FromHex(0xe94560, 0.6f),
                           12.0f);
        renderer.DrawRect({560, 310 + bounce, 300, 80}, ugui::Color::FromHex(0x0f3460, 0.8f),
                           8.0f);
        renderer.DrawRect({880, 310 + bounce, 300, 80}, ugui::Color::FromHex(0x0f3460, 0.8f),
                           8.0f);
