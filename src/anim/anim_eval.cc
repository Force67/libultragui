...
void evaluate_layer(const AnimLayer& layer, f32 normalized_t, EvaluatedLayer& out) {
    ...
    for (auto& track : layer.tracks) {
        ...
        if (is_color) {
            ...
            case AnimProperty::kX: out.x = v; break;
            case AnimProperty::kY: out.y = v; break;
            case AnimProperty::kW: out.w = v; break;
            case AnimProperty::kH: out.h = v; break;
            case AnimProperty::kR: out.r = v; break;
            case AnimProperty::kCx: out.cx = v; break;
            case AnimProperty::kCy: out.cy = v; break;
            case AnimProperty::kRx: out.rx = v; break;
            case AnimProperty::kRy: out.ry = v; break;
            case AnimProperty::kRotation: out.rotation = v; break;
            case AnimProperty::kScaleX: out.scale_x = v; break;
            case AnimProperty::kScaleY: out.scale_y = v; break;
            case AnimProperty::kOpacity: out.opacity = v; break;
            case AnimProperty::kStrokeWidth: out.stroke_width = v; break;
            case AnimProperty::kCornerRadius: out.corner_radius = v; break;
            default: break;
            }
        }
    }
