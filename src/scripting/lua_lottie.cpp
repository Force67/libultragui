...
void register_lottie_lua(
    ...
    lua.register_function("load_lottie", [loader](lua_State* L) -> int {
    ...
    lua.register_function("lottie_play", [](lua_State* L) -> int {
    ...
    lua.register_function("lottie_pause", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
        if (a) a->pause();
        return 0;
    });
    ...
    lua.register_function("lottie_stop", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
        if (a) a->stop();
        return 0;
    });
    ...
    lua.register_function("lottie_loop", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
    ...
    lua.register_function("lottie_speed", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
    ...
    lua.register_function("lottie_seek", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
    ...
    lua.register_function("lottie_playing", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
    ...
    lua.register_function("lottie_progress", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
    ...
    lua.register_function("lottie_duration", [](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
    ...
    lua.register_function("lottie_attach", [find_widget](lua_State* L) -> int {
        auto* a = static_cast<LottieAnimation*>(lua_touserdata(L, 1));
