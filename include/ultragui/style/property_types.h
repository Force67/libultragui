...
/// Supports pixels, percentages, viewport-relative, fractional, and auto
/// sizing.
struct Length {
  enum class Unit : u8 {
    kPx,       // Absolute pixels
  ...
  /// For Frac unit, uses viewport_w for width properties and viewport_h for
  /// height. The `for_height` flag selects which viewport dimension Frac maps
  /// to.
